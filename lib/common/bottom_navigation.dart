...
import 'package:sample_l10n_key_preview/sample_d/sample_d_screen.dart';
import 'package:sample_l10n_key_preview/sample_e/sample_e_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(icon: Icon(Icons.person), label: 'E'),
        ],
